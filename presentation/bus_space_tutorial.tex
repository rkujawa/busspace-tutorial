...
\begin{frame}
\frametitle{Designing the interface}
\begin{itemize}
	\item Interface between kernel driver and userspace can be designed in many different ways
	\item Most of them will utilise the device files
	\item Even when using the device files there is no single method that fits all use cases
	\item read/write
	\item  
