...
\begin{itemize}
	...
	\item Has few registers in the PCI memory space
	\item Addition operation in hardware
\end{itemize}
\end{frame}

\begin{frame}
\frametitle{Our hardware - technical details (PCI configuration)}
\begin{itemize}
	\item PCI configuration register 0x10 (Base Address Register) defines... 
	\item Memory mapped registers are 16 bytes...
\end{itemize}
\end{frame}
